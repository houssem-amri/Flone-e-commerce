...
const MyAccount = ({ location }) => {
  ...
  const getUserById = () => {
    axios
      .get(
        "http://localhost:3200/api/get_client_byId/" + CurrentUser.userId
      )
      .then((res) => {
                          ...
                          <div className="myaccount-info-wrapper">
                            ...
                            <div className="billing-back-btn">
                              <div className="billing-btn">
                                <button type="button" onClick={accountEdit}>Continue</button>
                              </div>
                            </div>
                          </div>
                        </Card.Body>
                        ...
                        <Card.Body>
                          <div className="myaccount-info-wrapper">
                            ...
                            <div className="myaccount-info-wrapper">
                              ...
                              <div className="billing-back-btn">
                                <div className="billing-btn">
                                  <button type="button" onClick={accountAdressBook}>Continue</button>
                                </div>
                              </div>
                            </div>
                          </div>
