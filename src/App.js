...
import React, { useEffect, Suspense, lazy, Fragment, useState, useContext } from "react";
...
const App = (props) => {
  ...
  return (
    <UserContext.Provider value={valueUserContext}>
      ...
      {CurrentUser.role==="super_admin" || CurrentUser.role === "conseilleur" ? (
    ...
    <Route
                    path={"/Table_orders"}
                    component={Table_orders}
                  />

                  <Route exact path={"/"} component={Analyse_dashboard} />
                  {/* <Route path="conseilleur/Table_user">
                <Table_User />
              </Route> */}
                </Switch>
              </Suspense>
